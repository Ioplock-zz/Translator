...
import static com.example.yatranslete.MainActivity.et;
import static com.example.yatranslete.MainActivity.langf;
import static com.example.yatranslete.MainActivity.langs;
import static com.example.yatranslete.MainActivity.langt;
...
public class ManyTransTask extends AsyncTask<Integer, Void, String> {
    ...
    public String transForManyLangs(int c) throws ExecutionException, InterruptedException {
        String last_lang = "";
        String lastl_lang = "";
